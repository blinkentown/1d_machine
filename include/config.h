...
constexpr uint8_t LIGHTS_OUT_BASE_SCRAMBLES = 3;
constexpr uint8_t LIGHTS_OUT_MAX_EXTRA_SCRAMBLES = 9;
constexpr uint16_t LIGHTS_OUT_SUCCESS_MS = 900;
constexpr uint16_t LIGHTS_OUT_ROUND_MS = 800;
constexpr uint8_t LIGHTS_OUT_DUEL_SCORE_TO_WIN = 3;
constexpr uint32_t LIGHTS_OUT_ON_COLOR = 0x0040FFUL;
constexpr uint32_t LIGHTS_OUT_CURSOR_COLOR = 0xFFFFFFUL;
constexpr uint32_t LIGHTS_OUT_PLAYER_1_CURSOR_COLOR = 0xFF0000UL;
